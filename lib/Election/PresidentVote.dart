...
class _PresidentState extends State<President> {
  ...
  Future<void> _submitVote(String name) async {
    final docRef =
    FirebaseFirestore.instance.collection('Election').doc('President');
      ...
      body: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            title: const Text('Muskan Makhija'),
            trailing: Checkbox(
